-- CreateSchema
-- schema nexa_dev pre-created by Akshay
SET search_path TO "nexa_dev";

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SEL', 'DIRECTOR', 'ED', 'PARTNER', 'ADMIN');

-- CreateEnum
CREATE TYPE "LineOfBusiness" AS ENUM ('TECH', 'ANALYTICS', 'MS', 'DS', 'DESIGN', 'AUXO');

-- CreateEnum
CREATE TYPE "OpportunityStatus" AS ENUM ('OPEN', 'WON', 'LOST', 'ABANDONED', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "OpportunityStage" AS ENUM ('LEAD', 'PRICE_LINKING_PENDING', 'PRICE_LINKED', 'APPROVAL_PENDING', 'SOW_PENDING', 'SOW_SUBMITTED', 'SOW_REVIEW_PENDING', 'TO_BE_ARCHIVED');
...
CREATE TABLE "opportunities" (
    ...
    "preContractAgreed" BOOLEAN NOT NULL DEFAULT false,
    "projectCodeProceed" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "staffing_resources" (
    ...
    "rateCardId" TEXT,
    "resourceDesignation" TEXT NOT NULL,
    "pot_mem" TEXT,
...
CREATE TABLE "approval_requests" (
    ...
    "approvalType" TEXT NOT NULL DEFAULT 'PRICING',
    "status" "ApprovalStatus" NOT NULL DEFAULT 'PENDING',
    "rejectionReason" TEXT,
    "businessJustification" TEXT,
    "pricingVersionNumber" INTEGER,
    "emailMessageId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "rate_cards_jobRole_location_domain_effectiveFrom_key" ON "rate_cards"("jobRole", "location", "domain", "effectiveFrom");
...
-- AddForeignKey
ALTER TABLE "client_requests" ADD CONSTRAINT "client_requests_reviewedById_fkey" FOREIGN KEY ("reviewedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "opportunities" ADD CONSTRAINT "opportunities_co_owner_id_fkey" FOREIGN KEY ("co_owner_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "approval_requests" ADD CONSTRAINT "approval_requests_approver2_id_fkey" FOREIGN KEY ("approver2_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "po_documents" ADD CONSTRAINT "po_documents_opportunityId_fkey" FOREIGN KEY ("opportunityId") REFERENCES "opportunities"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "po_documents" ADD CONSTRAINT "po_documents_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
