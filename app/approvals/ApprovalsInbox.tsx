...
function ApprovalCard({
  ...
  return (
    <div className={`rounded-2xl border bg-white shadow-sm overflow-hidden ${
      ...
      {/* Header */}
      <div className={`px-5 py-3 flex items-center justify-between ${isPending ? 'bg-amber-50' : 'bg-slate-50'}`}>
      ...
      <div>
        ...
        {pending.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-200 bg-white p-12 text-center">
            ...
            <p className="text-xs text-slate-400 mt-1">No pricing approvals waiting for your decision.</p>
          </div>
        ) : (
