  ...
  return (
    ...
    >
      ...
      <div className="mb-6 flex items-center gap-6">
        <div className="rounded-xl bg-white border border-slate-200 px-5 py-3 flex items-center gap-3">
        ...
        <div className="rounded-xl bg-white border border-slate-200 px-5 py-3 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-900">
              {clients.reduce((s, c) => s + c._count.opportunities, 0)}
            </p>
        ...
        <div className="rounded-xl bg-white border border-slate-200 px-5 py-3 flex items-center gap-3">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-900">
              {clients.reduce((s, c) => s + c.pocs.length, 0)}
            </p>
            <p className="text-xs text-slate-500">POC Contacts</p>
          </div>
        </div>
      </div>
